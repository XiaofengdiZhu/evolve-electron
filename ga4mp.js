...
function createClient(apiSecret, measurementId, clientId, user_id) {
    let newConnection = new GA4MPClient(apiSecret, measurementId, clientId, user_id);
